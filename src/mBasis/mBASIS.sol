...
contract mBASIS is mTBILL {
     ...
     */
    bytes32 public constant M_BASIS_MINT_OPERATOR_ROLE = keccak256("M_BASIS_MINT_OPERATOR_ROLE");

    /**
     * @notice actor that can burn mBASIS
     */
    bytes32 public constant M_BASIS_BURN_OPERATOR_ROLE = keccak256("M_BASIS_BURN_OPERATOR_ROLE");

    /**
     * @notice actor that can pause mBASIS
     */
    bytes32 public constant M_BASIS_PAUSE_OPERATOR_ROLE = keccak256("M_BASIS_PAUSE_OPERATOR_ROLE");
