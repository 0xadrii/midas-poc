...
abstract contract Blacklistable is WithMidasAccessControl {
    ...
    function __Blacklistable_init(address _accessControl) internal onlyInitializing {
     ...
     * have BLACKLISTED_ROLE
     */
    function _onlyNotBlacklisted(address account) internal view onlyNotRole(BLACKLISTED_ROLE, account) {}
}
